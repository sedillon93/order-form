...
var dogDuck = new Product('Dog duckbill', 'dog-duck', 'img/dog-duck.jpg');
var dragon = new Product('Dragon meat', 'dragon', 'img/dragon.jpg');
var pen = new Product('Utensil pen caps', 'pen', 'img/pen.jpg');
var petSweep = new Product('Pet sweeper shoes','pet-sweep', 'img/pet-sweep.jpg');
...
var wineGlass = new Product('Wine glass', 'wine-glass', 'img/wine-glass.jpg');
